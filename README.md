...
| `npm test` (Vitest, 15 tests) | unlock rules, streaks, spaced review, i18n key parity and fallback, content integrity (29 lessons, 7 tests, 4 projects), answer normalisation — all pass |
